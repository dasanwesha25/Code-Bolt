...
function SnippetsPage() {
    ...
    const [selectedLanguage, setSelectedLanguage] = useState<string | null>(null);   //this state can be a string or a null state by default it is null
    const [view, setView] = useState<"grid" | "list">("grid");          //grid view or list view, by deafult grid view
    ...
    const languages = [...new Set(snippets.map((s) => s.language))];    // to have one of thhe language at a time
